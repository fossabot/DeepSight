...
class Model(models.Model):
    ...
    category = models.ForeignKey(ModelCategory, on_delete=models.CASCADE, related_name="models")
...
class ProcessedImage(models.Model):
    image = models.OneToOneField(Image, on_delete=models.CASCADE, related_name="processed_image")
    model = models.ForeignKey(Model, on_delete=models.CASCADE, related_name="processed_images")
